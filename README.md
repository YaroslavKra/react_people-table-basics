...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://YaroslavKra.github.io/react_people-table-basics/) and add it to the PR description.
